...
def couchdb(db_name,URL):
    ...
    for pais in db_name:
        ...
        try:
            ...
            sys.exit()
        vista= pais[:4]
        url = 'http://'+URL+':5984/'+pais+'/_design/'+vista+'/_view/'+vista+''
        ...
        for x in d['rows']:
            ...
            if lstHashtags["principal"] in texto or lstHashtags["secundario"] in texto or lstHashtags["alterno"] or lstHashtags[db_name] in texto:
                ...
                if hour == 'Fri Jul 06':
                    lstHoras[0]+=1
                elif hour == 'Sat Jul 07':
                    lstHoras[1]+=1
                elif hour == 'Tue Jul 10':
                    lstHoras[2]+=1
                elif hour == 'Wed Jul 11':
                    lstHoras[3]+=1
                elif hour == 'Sat Jul 14':
                    lstHoras[4]+=1
                elif hour == 'Sun Jul 15':
                    lstHoras[5]+=1
       
    fig = plt.figure(u'Gráfica Todos los países') # Figure
    ax = fig.add_subplot(111) # Axes
    nombres = ['Fri Jul 06','Sat Jul 07','Tue Jul 10','Wed Jul 11','Sat Jul 14','Sun Jul 15']
